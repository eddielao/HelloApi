...
namespace HelloApi.Controllers
{
    ...
    public class ValuesController : ApiController
    {
        ...
        [AllowAnonymous]
        [HttpGet]
        [Route("api/Values/BindFavroiteColor")]
        ...
        public IHttpActionResult CustomHttpParameterBinding([ProductBinding] Product product)
        {
            Debugger.Break();
        ...
        [AllowAnonymous]
        [HttpGet]
        [Route("api/Values/CustomModeAttributeBinding")]
        public IHttpActionResult CustomModelAttributeBding([ProductModelBinder] Product product)
        {
            Debugger.Break();
